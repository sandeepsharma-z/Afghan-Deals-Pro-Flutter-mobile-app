...
const _kSubTypes = <String, List<_SubType>>{
  'men': [
    ...
    _SubType('Jeans',          'jeans',         Icons.man),
    _SubType('Shalwar Kameez', 'shalwar-kameez',Icons.person),
  ...
  'women': [
    ...
    _SubType('Jeans',          'jeans',         Icons.female),
  ...
  'kids-fashion': [
    ...
    _SubType('Kids Shoes',     'kids-shoes',    Icons.directions_walk),
  ...
  'jewelry': [
    ...
    _SubType('Earrings',       'earrings',      Icons.circle),
