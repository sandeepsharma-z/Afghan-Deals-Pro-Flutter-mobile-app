...
class _SubType {
  ...
  final String slug;
  final String emoji;
  const _SubType(this.label, this.slug, this.emoji);
}

const _kSubTypes = <String, List<_SubType>>{
  'men': [
    _SubType('Shirts',         'shirts',         '👔'),
    _SubType('T-Shirts',       't-shirts',        '👕'),
    _SubType('Jeans',          'jeans',           '👖'),
    _SubType('Shalwar Kameez', 'shalwar-kameez',  '🥻'),
    _SubType('Jackets',        'jackets',         '🧥'),
    _SubType('Kurta',          'kurta',           '🩱'),
    _SubType('Accessories',    'accessories',     '⌚'),
  ],
  'women': [
    _SubType('Dresses',        'dresses',         '👗'),
    _SubType('Shalwar Kameez', 'shalwar-kameez',  '🥻'),
    _SubType('Abayas',         'abayas',          '🧕'),
    _SubType('Tops',           'tops',            '👚'),
    _SubType('Jeans',          'jeans',           '👖'),
    _SubType('Dupatta/Scarf',  'dupatta-scarf',   '🧣'),
    _SubType('Accessories',    'accessories',     '💄'),
  ],
  'kids-fashion': [
    _SubType('Boys Wear',      'boys-wear',       '👦'),
    _SubType('Girls Wear',     'girls-wear',      '👧'),
    _SubType('Baby Clothes',   'baby-clothes',    '👶'),
    _SubType('School Uniform', 'school-uniform',  '🎒'),
    _SubType('Party Wear',     'party-wear',      '🎉'),
    _SubType('Kids Shoes',     'kids-shoes',      '👟'),
    _SubType('Accessories',    'accessories',     '🎀'),
  ],
  'bags': [
    _SubType('Handbags',       'handbags',        '👜'),
    _SubType('Backpacks',      'backpacks',       '🎒'),
    _SubType('School Bags',    'school-bags',     '🏫'),
    _SubType('Travel Bags',    'travel-bags',     '🧳'),
    _SubType('Wallets',        'wallets',         '👛'),
    _SubType('Clutches',       'clutches',        '👝'),
    _SubType('Pouches',        'pouches',         '💼'),
  ],
  'footwear': [
    _SubType('Men\'s Shoes',   'mens-shoes',      '👞'),
    _SubType('Women\'s Shoes', 'womens-shoes',    '👠'),
    _SubType('Kids\' Shoes',   'kids-shoes',      '👟'),
    _SubType('Sandals',        'sandals',         '🩴'),
    _SubType('Boots',          'boots',           '🥾'),
    _SubType('Sports Shoes',   'sports-shoes',    '👟'),
    _SubType('Slippers',       'slippers',        '🩰'),
  ],
  'jewelry': [
    _SubType('Necklaces',      'necklaces',       '📿'),
    _SubType('Earrings',       'earrings',        '✨'),
    _SubType('Rings',          'rings',           '💍'),
    _SubType('Bracelets',      'bracelets',       '📿'),
    _SubType('Bangles',        'bangles',         '🔮'),
    _SubType('Sets',           'sets',            '💎'),
    _SubType('Anklets',        'anklets',         '🦶'),
  ],
  'watches-accessories': [
    _SubType('Watches',        'watches',         '⌚'),
    _SubType('Sunglasses',     'sunglasses',      '🕶️'),
    _SubType('Belts',          'belts',           '🪡'),
    _SubType('Caps & Hats',    'caps-hats',       '🧢'),
    _SubType('Ties',           'ties',            '👔'),
    _SubType('Scarves',        'scarves',         '🧣'),
    _SubType('Wallets',        'wallets',         '👛'),
  ],
};
