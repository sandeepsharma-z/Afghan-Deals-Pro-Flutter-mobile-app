...
const _kSubTypes = <String, List<_SubType>>{
  'men': [
    ...
    _SubType('Jeans',          'jeans',         Icons.view_stream_outlined),
    _SubType('Shalwar Kameez', 'shalwar-kameez',Icons.accessibility_new_outlined),
    _SubType('Jackets',        'jackets',       Icons.layers_outlined),
    _SubType('Kurta',          'kurta',         Icons.dry_cleaning_outlined),
    _SubType('Accessories',    'accessories',   Icons.watch_outlined),
  ],
  'women': [
    _SubType('Dresses',        'dresses',       Icons.dry_cleaning_outlined),
    _SubType('Shalwar Kameez', 'shalwar-kameez',Icons.accessibility_new_outlined),
    _SubType('Abayas',         'abayas',        Icons.person_outlined),
    _SubType('Tops',           'tops',          Icons.checkroom_outlined),
    _SubType('Jeans',          'jeans',         Icons.view_stream_outlined),
    _SubType('Dupatta/Scarf',  'dupatta-scarf', Icons.waves_outlined),
  ...
  'kids-fashion': [
    ...
    _SubType('Kids Shoes',     'kids-shoes',    Icons.snowshoeing_outlined),
    _SubType('Accessories',    'accessories',   Icons.toys_outlined),
  ],
  'bags': [
    _SubType('Handbags',       'handbags',      Icons.shopping_bag_outlined),
    _SubType('Backpacks',      'backpacks',     Icons.backpack_outlined),
    _SubType('School Bags',    'school-bags',   Icons.backpack_outlined),
    _SubType('Travel Bags',    'travel-bags',   Icons.luggage_outlined),
    _SubType('Wallets',        'wallets',       Icons.account_balance_wallet_outlined),
    _SubType('Clutches',       'clutches',      Icons.inventory_2_outlined),
    _SubType('Pouches',        'pouches',       Icons.inbox_outlined),
  ],
  'footwear': [
    _SubType('Men\'s Shoes',   'mens-shoes',    Icons.snowshoeing_outlined),
    _SubType('Women\'s Shoes', 'womens-shoes',  Icons.directions_walk_outlined),
    _SubType('Kids\' Shoes',   'kids-shoes',    Icons.snowshoeing_outlined),
    _SubType('Sandals',        'sandals',       Icons.beach_access_outlined),
    _SubType('Boots',          'boots',         Icons.hiking_outlined),
    _SubType('Sports Shoes',   'sports-shoes',  Icons.sports_outlined),
    _SubType('Slippers',       'slippers',      Icons.hotel_outlined),
  ],
  'jewelry': [
    _SubType('Necklaces',      'necklaces',     Icons.lens_outlined),
    _SubType('Earrings',       'earrings',      Icons.adjust_outlined),
    _SubType('Rings',          'rings',         Icons.radio_button_unchecked),
    _SubType('Bracelets',      'bracelets',     Icons.data_usage_outlined),
    _SubType('Bangles',        'bangles',       Icons.circle_outlined),
    _SubType('Sets',           'sets',          Icons.diamond_outlined),
    _SubType('Anklets',        'anklets',       Icons.show_chart_outlined),
  ],
  'watches-accessories': [
    _SubType('Watches',        'watches',       Icons.watch_outlined),
    _SubType('Sunglasses',     'sunglasses',    Icons.remove_red_eye_outlined),
    _SubType('Belts',          'belts',         Icons.linear_scale_outlined),
    _SubType('Caps & Hats',    'caps-hats',     Icons.sports_baseball_outlined),
    _SubType('Ties',           'ties',          Icons.receipt_long_outlined),
    _SubType('Scarves',        'scarves',       Icons.waves_outlined),
    _SubType('Wallets',        'wallets',       Icons.account_balance_wallet_outlined),
  ],
};
