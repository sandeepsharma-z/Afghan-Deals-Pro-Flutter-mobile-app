...
class _FurnitureFilterScreenState extends ConsumerState<FurnitureFilterScreen> {
  ...
  bool _sectionHasValue(int i) {
    switch (i) {
      case 0:
        return _draft.subcategories.isNotEmpty;
      case 1:
      ...
      case 6:
        return _draft.usages.isNotEmpty;
      case 7:
        return _draft.roomTypes.isNotEmpty;
      case 8:
        return _draft.itemShapes.isNotEmpty;
      case 9:
        return _draft.fillMaterials.isNotEmpty;
      case 10:
        return _draft.colors.isNotEmpty;
      case 11:
        return _draft.shapes.isNotEmpty;
      case 12:
        return _draft.types.isNotEmpty;
      case 13:
        return _draft.materials.isNotEmpty;
      default:
        return false;
    }
  }
  ...
  Widget _buildSectionContent() {
    switch (_selectedSection) {
      case 0:
        return _checklistSection(
          ref.watch(furnitureSubcategoriesProvider).when(
                ...
                data: (subs) =>
                    AsyncValue.data(subs.map((s) => s.name).toList()),
              ),
          selected: _draft.subcategories,
          onToggle: (v) => setState(() => _draft =
              _draft.copyWith(subcategories: _toggle(_draft.subcategories, v))),
        );
      case 1:
      ...
      case 2:
        return _checklistSection(
            ref.watch(
                furnitureConditionsBySubcategoryProvider(widget.subcategory)),
      ...
      case 4:
        return _checklistSection(
            ref.watch(
                furnitureSellerTypesBySubcategoryProvider(widget.subcategory)),
            selected: _draft.sellerTypes,
            onToggle: (v) => setState(() => _draft =
                _draft.copyWith(sellerTypes: _toggle(_draft.sellerTypes, v))));
      case 5:
        return _checklistSection(
            ref.watch(furnitureAgesBySubcategoryProvider(widget.subcategory)),
            selected: _draft.ages,
            onToggle: (v) => setState(
                () => _draft = _draft.copyWith(ages: _toggle(_draft.ages, v))));
      case 6:
        return _checklistSection(
            ref.watch(furnitureUsagesBySubcategoryProvider(widget.subcategory)),
      ...
      case 7:
        return _checklistSection(
            ref.watch(
                furnitureRoomTypesBySubcategoryProvider(widget.subcategory)),
      ...
      case 8:
        return _checklistSection(
            ref.watch(
                furnitureItemShapesBySubcategoryProvider(widget.subcategory)),
            selected: _draft.itemShapes,
            onToggle: (v) => setState(() => _draft =
                _draft.copyWith(itemShapes: _toggle(_draft.itemShapes, v))));
      case 9:
        return _checklistSection(
            ref.watch(furnitureFillMaterialsBySubcategoryProvider(
                widget.subcategory)),
      ...
      case 11:
        return _checklistSection(
            ref.watch(furnitureShapesBySubcategoryProvider(widget.subcategory)),
            selected: _draft.shapes,
            onToggle: (v) => setState(() =>
                _draft = _draft.copyWith(shapes: _toggle(_draft.shapes, v))));
      case 12:
        return _checklistSection(
            ref.watch(furnitureTypesBySubcategoryProvider(widget.subcategory)),
      ...
      case 13:
        return _checklistSection(
            ref.watch(
                furnitureMaterialsBySubcategoryProvider(widget.subcategory)),
  ...
  Widget _brandSection() {
    return ref
        .watch(furnitureBrandsBySubcategoryProvider(widget.subcategory))
        .when(
          loading: () => const Padding(
            padding: EdgeInsets.all(20),
            child: Center(
                ...
                ...filtered.map((b) {
                  ...
                  return _CheckRow(
                    ...
                    onTap: () => setState(() => _draft =
                        _draft.copyWith(brands: _toggle(_draft.brands, b))),
                  );
                }),
            ]);
          },
  ...
  Widget _colorSection() {
    return ref
        .watch(furnitureColorsBySubcategoryProvider(widget.subcategory))
        .when(
          loading: () => const Padding(
            padding: EdgeInsets.all(20),
            child: Center(
  ...
  Widget _priceSection() {
    return ref
        .watch(furnitureMaxPriceBySubcategoryProvider(widget.subcategory))
        .when(
          loading: () => const Padding(
            padding: EdgeInsets.all(20),
            child: Center(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Available up to AFN ${maxVal.toStringAsFixed(0)}',
