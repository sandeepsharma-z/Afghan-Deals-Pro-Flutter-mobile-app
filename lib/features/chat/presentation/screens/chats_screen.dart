...
class ChatsScreen extends ConsumerStatefulWidget {
  ...
  const ChatsScreen({super.key, this.onExploreListings});
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Open any listing and tap Chat to start a conversation.',
                              textAlign: TextAlign.center,
                              style: GoogleFonts.montserrat(
...
class _ChatTile extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            ClipRRect(
              borderRadius: BorderRadius.circular(8),
              child: item.listingImageUrl != null && item.listingImageUrl!.isNotEmpty
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(_formatTime(item.lastMessageAt),
                          style: GoogleFonts.poppins(
                              fontSize: 11,
                              color: hasUnread ? const Color(0xFF2258A8) : Colors.black45,
                  ...
                  Text(item.listingTitle,
                      ...
                      overflow: TextOverflow.ellipsis,
                      style: GoogleFonts.poppins(
                          fontSize: 12, fontWeight: FontWeight.w500, color: const Color(0xFF2258A8))),
                  const SizedBox(height: 2),
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          item.lastMessage.isEmpty ? 'Tap to start conversation' : item.lastMessage,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.poppins(
                              fontSize: 12,
  ...
  Widget _thumb() => Container(
        ...
        child: const Icon(Icons.image_outlined, color: Color(0xFF98A2B3), size: 22));
}
