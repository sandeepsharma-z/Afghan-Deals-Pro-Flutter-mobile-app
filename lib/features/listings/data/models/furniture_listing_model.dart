class FurnitureListingModel {
  ...
  factory FurnitureListingModel.fromMap(Map<String, dynamic> map) {
    ...
    return FurnitureListingModel(
      ...
      material: cd['material']?.toString() ?? '',
      itemShape: cd['item_shape']?.toString() ?? '',
      fillMaterial: cd['fill_material']?.toString() ?? '',
      shape: cd['shape']?.toString() ?? '',
      type: cd['type']?.toString() ?? '',
      roomType: cd['room_type']?.toString() ?? '',
